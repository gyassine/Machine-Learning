# Kernel PCA
# ==========
# https://www.youtube.com/watch?v=DL7VXvgEo-0
# Kernel PCA est utilisé lorsqu'on ne peut pas séparer de manière linéaire les data
...
# Applying Kernel PCA   (A commenter si on veut voir la différence avec/sans...)
